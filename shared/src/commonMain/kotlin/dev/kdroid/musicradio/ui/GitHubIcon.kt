...
/**
 * The GitHub mark, used to label links that lead to GitHub. Path data is the official mark as
 * published by simple-icons; parsing it at build time beats hand-transcribing curve nodes.
 */
